...
plot(tableFeb$Timestamp, tableFeb$Sub_metering_1, xlab="Day/Time", ylab="Energy sub metering", type="l")
...
plot(tableFeb$Timestamp, tableFeb$Global_reactive_power, xlab="Day/Time", ylab="Global reactive power", type="l")
dev.off()